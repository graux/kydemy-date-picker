            ...
            <div class="content-wrapper is-relative">
              <transition-group name="fade" :duration="{ enter: 200, leave: 100 }" mode="out-in">
                <div v-if="displayMode === 'day'" :key="'displayMode_day'">
                  ...
                  <div
                    class="columns is-variable is-1 is-marginless is-paddingless is-mobile kydemy-calendar is-multiline">
                    <div
...
export default {
  props: {
    value: {type: [Object, Array, String], default: today},
    locale: {type: String, required: true},
    startDate: {type: [Object, String, null], default: null},
    ...
    enabledDates: {type: [Array, null], default: null},
    dimWeekends: {type: Boolean, default: false},
    highlighted: {type: [Array, null], default: null},
    disabled: {type: [Array, null], default: null},
    disabledControl: {type: Boolean, default: false},
    range: {type: Boolean, default: false},
    multiple: {type: Boolean, default: false},
    formatFunction: {type: Function, default: null},
    formatPattern: {type: String, default: null},
    ...
    iconLeft: {type: [String, Array], default: 'calendar'},
    iconRight: {type: [String, Array], default: 'chevron-down'},
